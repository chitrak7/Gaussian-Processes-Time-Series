...
sd=0.1
a = np.load("tide_data.npy",allow_pickle=True)
...
# k_seq = np.arange(180,220,step=4)
...
k1=k
aa = np.arange(n)
C = np.array([[ker(i,j,k,k1) for j in x_tr] for i in x_tr]) + 0.1*np.identity(x_tr.shape[0])
...
#[ 7.28567189e-01  2.84967439e-03 -7.70244960e-06]
